...
{% macro piperideradapter__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro piperideradapter__check_schema_exists(information_schema,schema) -%}
...
{% macro piperideradapter__create_schema(relation) -%}
...
{% macro piperideradapter__drop_relation(relation) -%}
...
{% macro piperideradapter__drop_schema(relation) -%}
...
{% macro piperideradapter__get_columns_in_relation(relation) -%}
...
{% macro piperideradapter__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro piperideradapter__list_schemas(database) -%}
...
{% macro piperideradapter__rename_relation(from_relation, to_relation) -%}
...
{% macro piperideradapter__truncate_relation(relation) -%}
...
{% macro piperideradapter__current_timestamp() -%}
